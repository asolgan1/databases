<!-- 
    ...
    Given two numbers for net_lb, find countries whose net_lb is between that range. Also indicate their stimulus if they have it.
-->
...
<body>
    ...
    if ($stmt = $conn->prepare("CALL NetLbRange(?, ?)")) {
